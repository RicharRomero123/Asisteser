...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 w-full flex items-center h-20 border-b  dark:border-b-veryDarkBlue z-40 bg-bright/90 dark:bg-veryDarkBlue/95 backdrop-filter backdrop-blur-xl">
        <nav className="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
          <div className="flex items-center min-w-max gap-4">
            <Link href="/" className="relative flex items-center gap-4">
              ...
              <span className="text-2xl font-bold text-darkBlue dark:text-light">Asisteser</span>
            </Link>
          </div>
          <div className={`
          ...
          `}>
            <ul className="flex flex-col lg:flex-row gap-6 lg:items-center text-darkBlue dark:text-light lg:w-full lg:justify-center">
              <li>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:min-w-max mt-10 lg:mt-0 sm:justify-center sm:text-center">
              ...
              <div className="flex gap-4 justify-center">
                <a href="https://www.facebook.com/asisteser" target="_blank" rel="noopener noreferrer">
                  <BiLogoFacebookSquare className="text-3xl text-darkBlue dark:text-white hover:text-green-600" />
                </a>
                <a href="https://www.instagram.com/asisteser?igsh=NjMyNmNhc251emZu" target="_blank" rel="noopener noreferrer">
                  <BiLogoInstagram className="text-3xl text-darkBlue dark:text-white hover:text-green-600" />
                </a>
              </div>
            </div>
            {isMobile && (
          ...
          <div className="flex items-center lg:hidden">
            <button onClick={() => {
              ...
              <span aria-hidden={true} className={`
                flex h-0.5 w-6 rounded bg-darkBlue dark:bg-light transition duration-300
