...
const metrics = [
  {
    id: 1,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={20} className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  },
  {
    id: 2,
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
