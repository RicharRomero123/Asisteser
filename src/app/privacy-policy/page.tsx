      ...
      <div className="max-w-2xl mx-auto p-8 bg-gray-950 rounded-xl mb-16">
        ...
        >
          ...
          <p className="text-white text-left mb-3">
            ...
            Asisteser recopila información personal de los usuarios de diversas
          ...
          <p className="text-white text-left mb-3">
            ...
            Asisteser puede compartir información con terceros en ciertas
          ...
          <p className="text-white text-left mb-3">
            <span className="text-yellow-400 font-bold">8. Contáctanos:</span> Si
